'''
    gets coordinates of rectangle around right dial
'''
import cv2
import csv
import os
...
input_folder = '/Users/labuser/Downloads/Honors/0'#'/Users/labuser/Downloads/2_dials_imgs' #'/Users/labuser/Documents/Gasmeter-Reader/images/imgs_12-11/'
output_folder = '/Users/labuser/Downloads/Honors/DeepGauge-ML-Demo/CustomEstimator/data/DigitsTrainingImgs' #'/Users/labuser/Documents/Dial code/images/dataset'#'/Users/labuser/Documents/Gasmeter-Reader/images/dial_1_imgs/
...
'''
    Get & Crop  one image
    and save its coordinates to be used to
...
print("Enter 'c' to break from the loop")
...
'''
      Crop all images using
      the ref coordinates saved from
      the previous step of the code
'''
...
for image_file in image_files:
    ...
    output_filename =  "Gasmeter_digit_{}.png".format(i)
    ...
    output_path = os.path.join(output_folder, current_val)
    output_path = os.path.join(output_path, image_file)
    print("output_path", output_path)
    saved = cv2.imwrite(output_path, roi)
